    ...
    public class Form1 : Form
    {
        ...
        private void SetupUI()
        {
            ...
            trackTemperature.Scroll += (s, e) =>
            {
                ...
                lblTemperature.Text = $"Температура: {trackTemperature.Value}°C";
            };
            this.Controls.Add(trackTemperature);
        ...
        private void HandleMouseInput(MouseEventArgs e)
        {
            ...
            {
                if (e.Button == MouseButtons.Left) grid[cx, cy] = CellState.Stone;
        ...
        private void InitializeGrid()
        {
            ...
            for (int x = 0; x < GridWidth; x++)
            {
                for (int y = 0; y < GridHeight; y++)
                {
                    ...
                    if (r < 0.05) grid[x, y] = CellState.Stone;
        ...
        private void UpdateModel()
        {
            for (int x = 0; x < GridWidth; x++)
            {
                for (int y = 0; y < GridHeight; y++)
                {
                    ...
                    else if (current == CellState.Stone) nextGrid[x, y] = CellState.Stone;
                }
            }
                ...
                for (int dy = -1; dy <= 1; dy++)
                {
                    ...
                    if (nx >= 0 && nx < GridWidth && ny >= 0 && ny < GridHeight)
                    {
                        if (grid[nx, ny] == CellState.Burning)
                        {
                            ...
                            burnChance += (temperature * 0.3);
                            burnChance = Math.Min(burnChance, 1.0);
                ...
                for (int x = 0; x < GridWidth; x++)
                {
                    for (int y = 0; y < GridHeight; y++)
                    {
                        ...
                        switch (state)
                        {
                            ...
                            case CellState.Stone: brush = Brushes.Gray; break;
                        }
